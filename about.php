<html>
    <head>
        ...
        <title>Sobre - ODAW - Diel e Conejo</title>
    </head>
    ...
    <body bgcolor='#454545'>
        ...
        <?php
            ...
            $conn->query("insert into usuario values(1, 'admin', 'admin', 'Administrador', '1'),
                (2, 'diel', 'diel', 'Gustavo Diel', '1'),
                (3, 'conejo', '123', 'Gabriel Guebarra Conejo', '1'),
                (4, 'visitante', '123', 'Visitante :3', '2');");
            $conn->query("insert into noticia values (1, 'mulher_em_ti', 'Mulheres em TI', 'Faz todo o sentido ein', 'https://leninja.com.br/wp-content/uploads/2017/11/jessicao.jpg', '02', 'maio', '2017', '1');");
        ?>
