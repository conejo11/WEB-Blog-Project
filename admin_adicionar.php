...
<form action="manage.php" method="post">
    ...
    <div class="field-wrap">
        ...
        <input type="text" name='dia' required autocomplete="off" />
    </div>
    <div class="field-wrap">
        <label>
            Mês<span class="req">*</span>
        </label>
        <input type="text" name='mes' required autocomplete="off" />
    </div>
    <div class="field-wrap">
        <label>
            Ano<span class="req">*</span>
        </label>
        <input type="text" name='ano' required autocomplete="off"  />
    </div>
    <div class="field-wrap">
        <select name="tag">
            <?php
